let b = 100; // referring to memory space in SCRIPT SCOPE( outside of block)
{
  ...
  console.log(b); // 20 ( let b of line 6 can't shadow let b of line1, because it is referring to memory space of BLOCK SCOPE for line 6)
}
console.log(b); //SCRIPT SCOPE
// 100 ( let b of line 6 can't shadow let b of line1,
